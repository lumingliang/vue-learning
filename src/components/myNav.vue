                ...
                <el-submenu index="1">
                    ...
                    <el-menu-item-group>
                        ...
                        <el-menu-item index="1-2">
                            <router-link class="icon-about iconfont item" :to="{'name':'test'}">测试新页</router-link>
                        </el-menu-item>
                    </el-menu-item-group>
                    <el-menu-item-group title="分组2">
                        <el-menu-item index="1-3">
                            <router-link class="icon-about iconfont item" :to="{'name':'list', params: { page: 1}}">列表</router-link>
                        </el-menu-item>
                    </el-menu-item-group>
